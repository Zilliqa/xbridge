...
contract registerLockProxy is Script, MainnetConfig {
  function run() external {
    ...
    // LockAndReleaseOrNativeTokenManagerUpgradeableV3 lockAndReleaseOrNativeTokenManager = LockAndReleaseOrNativeTokenManagerUpgradeableV3(payable(bscLockAndReleaseOrNativeTokenManagerUpgradeable));

    lockProxyTokenManager.setLockProxyData(bscLockProxy, bscLockProxyProxy);
    vm.stopBroadcast();
  }
