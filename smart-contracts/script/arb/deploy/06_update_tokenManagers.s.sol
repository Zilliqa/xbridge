...
contract Upgrade is Script, MainnetConfig {
    function run() external {
        ...
        {
          TokenManagerUpgradeable tokenManager = TokenManagerUpgradeable(arbLockAndReleaseOrNativeTokenManagerUpgradeable);
        ...
        // Update lockproxy 
        {
          TokenManagerUpgradeable tokenManager = TokenManagerUpgradeable(arbLockProxyTokenManager);
          vm.startBroadcast(deployerPrivateKey);
