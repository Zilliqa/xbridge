...
contract registerLockProxy is Script, MainnetConfig {
  function run() external {
    ...
    LockAndReleaseOrNativeTokenManagerUpgradeableV4 lockAndReleaseOrNativeTokenManager = LockAndReleaseOrNativeTokenManagerUpgradeableV4(payable(ethLockAndReleaseOrNativeTokenManagerUpgradeable));
    ChainGatewayUpgradeable chainGateway = ChainGatewayUpgradeable(ethChainGatewayAddress);
