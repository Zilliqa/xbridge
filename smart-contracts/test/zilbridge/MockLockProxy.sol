...
// This is a mock lock proxy - it looks like a LockProxy, but has the CCM stuff removed so that it can be
// deployed fairly easily. We use it to test the remote side of transfers, because otherwise we would have to
// generate a lot of complex spurious mechanism.
...
// THIS CONTRACT IS WOEFULLY INSECURE AND ONLY TO BE USED FOR TESTING!
contract MockLockProxy {
